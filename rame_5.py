    ...
    if st.session_state.design_df is not None:
        ...
        with st.spinner('🎨 Searching designs by selected filters...'):
            ...
            if not filtered_df.empty:
                ...
                if 'Frame-wise Color' in filtered_df.columns:
                    st.subheader("Frame-wise Color Mapping")
                    frame_colors_display = filtered_df[['Design Name', 'Frame-wise Color']].copy()
                    frame_colors_display = frame_colors_display[frame_colors_display['Frame-wise Color'].notna()]
